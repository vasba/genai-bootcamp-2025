...
class StudySessionController(
    ...
    @PostMapping
    fun createSession(@RequestBody request: CreateSessionRequest): ResponseEntity<ApiResponse<StudySessionDTO>> {
    ...
    fun getSessionReviews(@PathVariable id: Long): ResponseEntity<ApiResponse<List<WordReviewItemDTO>>> {
    ...
    @GetMapping("/{id}")
    fun getSessionById(@PathVariable id: Long): ResponseEntity<StudySessionDTO> {
    ...
    fun getSessionReviewItems(@PathVariable id: Long): ResponseEntity<List<WordReviewItemDTO>> {
        val session = studySessionService.getStudySessionById(id)
